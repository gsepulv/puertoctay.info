...
public function showAmigas(): void    {        $pageTitle = "Paginas Amigas — " . SITE_NAME;        $pageDescription = "Sitios web que recomendamos sobre Puerto Octay y la Region de Los Lagos.";        $viewName = "public/paginas-amigas";        require ROOT_PATH . "/views/layouts/main.php";    }

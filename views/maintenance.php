...
<div class="wrapper">
    ...
    <div class="socials">
        ...
        <?php if (!empty($redes['whatsapp'])): ?>
            <a href="<?= htmlspecialchars($redes['whatsapp']) ?>" target="_blank" rel="noopener" title="WhatsApp">
        ...
        <?php if (!empty($redes['twitter'])): ?>
            <a href="<?= htmlspecialchars($redes['twitter']) ?>" target="_blank" rel="noopener" title="Twitter / X">

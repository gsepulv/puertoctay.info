...
<aside class="panel-sidebar" id="panelSidebar">
    ...
    <nav>
        <a href="<?= SITE_URL ?>/mi-cuenta" class="<?= $__currentUri === '/mi-cuenta' ? 'active' : '' ?>">🏠 Mi Cuenta</a>
        <a href="<?= SITE_URL ?>/mi-cuenta/favoritos" class="<?= str_contains($__currentUri, '/mi-cuenta/favoritos') ? 'active' : '' ?>">❤️ Mis Favoritos</a>
        <a href="<?= SITE_URL ?>/mi-cuenta/resenas" class="<?= str_contains($__currentUri, '/mi-cuenta/resenas') ? 'active' : '' ?>">⭐ Mis Reseñas</a>
        <a href="<?= SITE_URL ?>/mi-cuenta/perfil" class="<?= str_contains($__currentUri, '/mi-cuenta/perfil') ? 'active' : '' ?>">👤 Mi Perfil</a>
